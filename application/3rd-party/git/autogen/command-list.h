...
static struct cmdname_help command_list[] = {
	...
	{ "git-sparse-checkout", N_("Initialize and modify the sparse-checkout"), 0 | CAT_mainporcelain },
	...
	{ "gitmailmap", N_("Map author/committer names and/or E-Mail addresses"), 0 | CAT_guide },
