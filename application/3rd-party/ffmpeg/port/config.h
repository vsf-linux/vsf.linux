...
#define FFMPEG_CONFIGURATION "--disable-x86asm --enable-ffplay --disable-iconv --disable-lzma --disable-v4l2_m2m --disable-outdev=oss --disable-indev=oss --enable-ffplay"
