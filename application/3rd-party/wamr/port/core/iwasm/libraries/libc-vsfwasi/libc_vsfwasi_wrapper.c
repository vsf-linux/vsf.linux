...
#define wasi_errno_t __wasi_errno_t
#define wasi_fd_t __wasi_fd_t
#define wasi_clockid_t __wasi_clockid_t
#define wasi_timestamp_t __wasi_timestamp_t
#define wasi_filesize_t __wasi_filesize_t
#define wasi_prestat_t __wasi_prestat_t
#define wasi_filedelta_t __wasi_filedelta_t
#define wasi_whence_t __wasi_whence_t
#define wasi_fdflags_t __wasi_fdflags_t
#define wasi_rights_t __wasi_rights_t
#define wasi_advice_t __wasi_advice_t
#define wasi_lookupflags_t __wasi_lookupflags_t
#define wasi_preopentype_t __wasi_preopentype_t
#define wasi_fdstat_t __wasi_fdstat_t
#define wasi_oflags_t __wasi_oflags_t
#define wasi_dircookie_t __wasi_dircookie_t
#define wasi_filestat_t __wasi_filestat_t
#define wasi_fstflags_t __wasi_fstflags_t
#define wasi_subscription_t __wasi_subscription_t
#define wasi_event_t __wasi_event_t
#define wasi_exitcode_t __wasi_exitcode_t
#define wasi_signal_t __wasi_signal_t
#define wasi_riflags_t __wasi_riflags_t
#define wasi_roflags_t __wasi_roflags_t
#define wasi_siflags_t __wasi_siflags_t
#define wasi_sdflags_t __wasi_sdflags_t
#define wasi_iovec_t __wasi_iovec_t
#define wasi_ciovec_t __wasi_ciovec_t
                    ...
                    wasi_timestamp_t precision, wasi_timestamp_t *time)
{
    ...
    return clock_gettime(clock_id, precision, time);
}
             ...
             const iovec_app_t *iovec_app, uint32 iovs_len, uint32 *nread_app)
{
    ...
    *nread_app = read(fd, iovec_begin, iovs_len);
               ...
               uint32 *ro_datalen_app, wasi_roflags_t *ro_flags)
{
    ...
    *(uint32 *)ro_datalen_app = recv(sock, iovec_begin, ri_data_len, ri_flags,
                           &ro_datalen, ro_flags);
               ...
               wasi_siflags_t si_flags, uint32 *so_datalen_app)
{
    ...
    *so_datalen_app = send(sock, ciovec_begin, si_data_len, si_flags);
